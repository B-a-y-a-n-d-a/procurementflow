...
3. Switch to **Sipho (Department Manager)**. The **Approvals inbox** shows it with a 48 h SLA countdown, plus a seeded **overdue** request in red. Approve.
...
1. Log in as **Johan (Procurement Officer)** → *Evaluations → OPP-2026-007*.
...
2. **Issue the PO**: PO-2026-00xx for R420 000. Show that the Environmental Services committed budget updated.
